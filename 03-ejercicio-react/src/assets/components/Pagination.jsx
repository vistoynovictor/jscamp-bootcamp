...
export function Pagination({ currentPage = 1, totalPages = 5, onPageChange}){
    ...
    return(
        <nav className={styles.pagination}>
            <a href="#" aria-label="Previous" title="Previous Page" style={stylePrevButton} onClick={handlePrevClick}>
            ...
            <a href="#" aria-label='Next' title="Next Page" style={styleNextButton} onClick={handleNextClick}>
