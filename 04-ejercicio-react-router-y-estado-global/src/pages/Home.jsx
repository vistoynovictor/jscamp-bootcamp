...
export default function HomePage(){
    ...
    return(
        <main>
            <section className={styles.imgHero}>
                <img src="../../public/background.webp" alt="Oficce"/>

                <h1>Encuentra el trabajo de tus sueños</h1>
                <p>Únete a la comunidad más grande de desarrolladores y encuentra tu próxima oportunidad.</p>

                <form role="search" onSubmit={handleSubmit} className={styles.landpgSearch}>
                    ...
                    <input type="text" name='search' placeholder="Buscar empleo por titulo, habilidad o empresa"/>

                    <button type="submit">Buscar</button>
                </form>
            </section>

            <section className={styles.landpgCards}>
                <header>
